...
// else{
	// $sql = "SELECT q.last_update, q.id, q.vehicle_type, q.status_type as 'status_type', st.name as 'status', q.owner_name, q.vehicle_number from queue q, status_type st where st.id = q.status_type";
// }
// $result = mysqli_query($con, $sql);
